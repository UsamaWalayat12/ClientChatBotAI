...
def load_history(user_id: str = "default", conversation_id: str = None, table_name: str = "chat_messages") -> List[Dict[str, str]]:
...
def add_to_history(history: List[Dict[str, str]], role: str, content: str, user_id: str = "default", conversation_id: str = "default", table_name: str = "chat_messages"):
...
def clear_history(user_id: str = "default", conversation_id: str = None, table_name: str = "chat_messages"):
    ...
    try:
        query = supabase.table(table_name).delete().eq('user_id', user_id)
        if conversation_id:
            query = query.eq('conversation_id', conversation_id)
